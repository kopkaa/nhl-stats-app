  ...
  <div class="d-flex flex-row card__topTen">
    ...
    <div class="flex-grow-1 d-flex  align-center flex-column pt-4">
      ...
      <div class="mt-3 text-center">
        <span class="body-1">#{{ showedPlayer.primaryNumber }} | </span><span class="body-1">{{ showedPlayer.fullName }}</span><br>
      ...
      <div class="mt-7 d-flex w-100 pa-4 justify-center">
        ...
        <span class="text-uppercase  subtitle-1 mr-5"><span class="blue--text text--lighten-3 mr-1">G:</span> {{ showedPlayer.stats.goals }}</span><br>
        <span class="text-uppercase  subtitle-1 mr-5"><span class="blue--text text--lighten-3 mr-1">A:</span> {{ showedPlayer.stats.assists }}</span><br>
        <span class="text-uppercase  subtitle-1"><span class="blue--text text--lighten-3 mr-1">toi:</span> {{ showedPlayer.stats.timeOnIcePerGame }}</span><br>
      </div>
